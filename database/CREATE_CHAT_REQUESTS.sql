-- Create Chat Request System
-- This handles private message requests with accept/decline functionality
...
-- 5. Function to clean up expired requests
...
-- 6. Function to get pending requests for a user
...
-- 7. Function to send a chat request
...
-- 8. Function to respond to a chat request
...
-- Success message
SELECT 'Chat request system created successfully!' as message;